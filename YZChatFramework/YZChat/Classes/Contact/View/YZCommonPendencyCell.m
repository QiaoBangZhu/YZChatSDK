...
@implementation YZCommonPendencyCell
...
- (void)fillWithData:(TCommonPendencyCellData *)pendencyData
{
    ...
    if (self.pendencyData.showTopCorner || self.pendencyData.showBottomCorner || self.pendencyData.showCorner) {
...
- (void)configureCorner {
    ...
    if (self.pendencyData.showTopCorner) {
        corners = UIRectCornerTopRight | UIRectCornerTopLeft;
    }
    if (self.pendencyData.showBottomCorner) {
        corners = UIRectCornerBottomRight | UIRectCornerBottomLeft;
    }
    
    if (self.pendencyData.showCorner) {
