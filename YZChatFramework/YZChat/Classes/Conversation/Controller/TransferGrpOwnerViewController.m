//
//  TransferGrpOwnerViewController.m
//  YChat
//
...
@interface TransferGrpOwnerViewController ()<SearchBarDelegate, UITableViewDelegate, UITableViewDataSource>
...
@implementation TransferGrpOwnerViewController
...
- (SearchBarView *)searchBarView {
    if (!_searchBarView) {
        _searchBarView  = [[SearchBarView alloc]initWithFrame:CGRectMake(0,0, KScreenWidth, 44)];
