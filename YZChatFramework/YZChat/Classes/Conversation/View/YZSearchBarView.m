...
@interface YZSearchBarView ()<UISearchBarDelegate>
...
@implementation YZSearchBarView
...
- (UISearchBar *)searchBar {
    if (!_searchBar) {
        ...
        if (@available(iOS 13.0, *)) {
            ...
            self.searchBar.searchTextField.backgroundColor = [UIColor colorWithHex:KCommonSearchBarBackgroundColor];
            ...
            = [UIColor colorWithHex:KCommonSearchBarBackgroundColor];
            [tf setBorderStyle:UITextBorderStyleNone];
            tf.background = YZChatResource(@"searchBar_shadow");
