...
@class YUIGroupInfoController;
@class TGroupMemberCellData;

/////////////////////////////////////////////////////////////////////////////////
//
//                         YUIChatControllerDelegate
//
/////////////////////////////////////////////////////////////////////////////////

@protocol YGroupInfoControllerDelegate <NSObject>
 ...
 */
- (void)groupInfoController:(YUIGroupInfoController *)controller didSelectMembersInGroup:(NSString *)groupId;
 ...
 */
- (void)groupInfoController:(YUIGroupInfoController *)controller didAddMembersInGroup:(NSString *)groupId members:(NSArray<TGroupMemberCellData *> *)members;
 ...
 *  @param members 群成员信息数据源，群组内存放的对象为（TGroupMemberCellData）
 */
- (void)groupInfoController:(YUIGroupInfoController *)controller didDeleteMembersInGroup:(NSString *)groupId members:(NSArray<TGroupMemberCellData *> *)members;

/**
 *  删除群组成功后的回调。如果因为网络等各种原因删除失败，该回调不会被调用。
 *  您可以通过该回调实现：（删除成功后）退出当前群组页面，返回消息列表。
 */
- (void)groupInfoController:(YUIGroupInfoController *)controller didDeleteGroup:(NSString *)groupId;

/**
 *  退出群组成功后的回调。如果因为网络等各种原因退群失败，该回调不会被调用。
 *  您可以通过该回调实现：（退出成功后）退出当前群组页面，返回消息列表。
 */
- (void)groupInfoController:(YUIGroupInfoController *)controller didQuitGroup:(NSString *)groupId;
/**
 *  选择修改头像的调用。
 ...
 *
 **/
- (void)groupInfoController:(YUIGroupInfoController *)controller didSelectMemberAvatar:(NSString *)memberId;

@end

/////////////////////////////////////////////////////////////////////////////////
//
//                         YUIGroupInfoController
//
/////////////////////////////////////////////////////////////////////////////////

/**
 * 【模块名称】YUIGroupInfoController
 ...
 */
@property (nonatomic, weak) id<YGroupInfoControllerDelegate> delegate;
