 ...
 *
 *  YMessageControllerDelegate 协议和 YUIMessageController 类。
 *  YUIMessageController 是聊天界面的核心类，负责聊天界面大部分核心业务逻辑的处理与运算。
 *  该类的详细属性与功能，请参展本文件中 YUIMessageController 的具体声明。
 *
 ******************************************************************************/
...
@class YUIMessageController;
/////////////////////////////////////////////////////////////////////////////////
//
//                         YMessageControllerDelegate
//
/////////////////////////////////////////////////////////////////////////////////
 ...
 */
@protocol YMessageControllerDelegate <NSObject>
 ...
 */
- (BOOL)messageController:(YUIMessageController *)controller willShowMenuInCell:(UIView *)view;
...
@interface YUIMessageController : UITableViewController

/**
 *  执行 YMessageControllerDelegate 协议的委托
 */
@property (nonatomic, weak) id<YMessageControllerDelegate> delegate;
/**
 *  发送消息
