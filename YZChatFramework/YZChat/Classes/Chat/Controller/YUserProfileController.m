...
@property YUserInfo * user;
@property BOOL canEdit;
@end

@implementation YUserProfileController {
...
- (void)viewDidLoad {
    ...
    [self.tableView registerClass:[YZAddFriendHeaderCell class] forCellReuseIdentifier:@"AddFriendHeaderCell"];
