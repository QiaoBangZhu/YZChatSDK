...
@interface CIGAMHelper (CIGAM_Interface)
 ...
 *  @see [CIGAMConfiguration automaticallyRotateDeviceOrientation]
 */
 ...
 *  @see [CIGAMHelper rotateToDeviceOrientation]
 */
