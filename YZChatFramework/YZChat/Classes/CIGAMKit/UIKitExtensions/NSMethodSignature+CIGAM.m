...
@implementation NSMethodSignature (CIGAM)

+ (NSMethodSignature *)cigam_avoidExceptionSignature {
...
- (const char *)cigam_typeEncoding {
    return self.cigam_typeString.UTF8String;
}
