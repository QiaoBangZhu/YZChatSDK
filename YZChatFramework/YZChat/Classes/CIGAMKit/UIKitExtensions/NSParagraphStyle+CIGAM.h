...
@interface NSMutableParagraphStyle (CIGAM)

/**
 *  快速创建一个NSMutableParagraphStyle，等同于`cigam_paragraphStyleWithLineHeight:lineBreakMode:NSLineBreakByWordWrapping textAlignment:NSTextAlignmentLeft`
 *  @param  lineHeight      行高
...
/**
 *  快速创建一个NSMutableParagraphStyle，等同于`cigam_paragraphStyleWithLineHeight:lineBreakMode:textAlignment:NSTextAlignmentLeft`
 *  @param  lineHeight      行高
