...
//
//  CIGAMCommonDefines.h
//  cigam
//
//  Created by CIGAM Team on 14-6-23.
//

#ifndef CIGAMCommonDefines_h
#define CIGAMCommonDefines_h
...
#define BeginIgnoreUIKVCAccessProhibited if (@available(iOS 13.0, *)) NSThread.currentThread.cigam_shouldIgnoreUIKVCAccessProhibited = YES;
#define EndIgnoreUIKVCAccessProhibited if (@available(iOS 13.0, *)) NSThread.currentThread.cigam_shouldIgnoreUIKVCAccessProhibited = NO;

#pragma mark - 变量-设备相关

/// 设备类型
#define IS_IPAD [CIGAMHelper isIPad]
#define IS_IPOD [CIGAMHelper isIPod]
#define IS_IPHONE [CIGAMHelper isIPhone]
#define IS_SIMULATOR [CIGAMHelper isSimulator]
#define IS_MAC [CIGAMHelper isMac]

/// 操作系统版本号，只获取第二级的版本号，例如 10.3.1 只会得到 10.3
#define IOS_VERSION ([[[UIDevice currentDevice] systemVersion] doubleValue])

/// 数字形式的操作系统版本号，可直接用于大小比较；如 110205 代表 11.2.5 版本；根据 iOS 规范，版本号最多可能有3位
#define IOS_VERSION_NUMBER [CIGAMHelper numbericOSVersion]
...
#define APPLICATION_WIDTH [CIGAMHelper applicationSize].width

/// 在 iPad 分屏模式下等于 app 实际运行宽度，否则等同于 DEVICE_HEIGHT
#define APPLICATION_HEIGHT [CIGAMHelper applicationSize].height

/// 是否全面屏设备
#define IS_NOTCHED_SCREEN [CIGAMHelper isNotchedScreen]
/// iPhone 12 Pro Max
#define IS_67INCH_SCREEN [CIGAMHelper is67InchScreen]
/// iPhone XS Max
#define IS_65INCH_SCREEN [CIGAMHelper is65InchScreen]
/// iPhone 12 / 12 Pro
#define IS_61INCH_SCREEN_AND_IPHONE12 [CIGAMHelper is61InchScreenAndiPhone12]
/// iPhone XR
#define IS_61INCH_SCREEN [CIGAMHelper is61InchScreen]
/// iPhone X/XS
#define IS_58INCH_SCREEN [CIGAMHelper is58InchScreen]
/// iPhone 6/7/8 Plus
#define IS_55INCH_SCREEN [CIGAMHelper is55InchScreen]
/// iPhone 12 mini
#define IS_54INCH_SCREEN [CIGAMHelper is54InchScreen]
/// iPhone 6/7/8
#define IS_47INCH_SCREEN [CIGAMHelper is47InchScreen]
/// iPhone 5/5S/SE
#define IS_40INCH_SCREEN [CIGAMHelper is40InchScreen]
/// iPhone 4/4S
#define IS_35INCH_SCREEN [CIGAMHelper is35InchScreen]
/// iPhone 4/4S/5/5S/SE
...
#define IS_ZOOMEDMODE [CIGAMHelper isZoomedMode]

#pragma mark - 变量-布局相关

/// 获取一个像素
#define PixelOne [CIGAMHelper pixelOne]
...
#define StatusBarHeightConstant (UIApplication.sharedApplication.statusBarHidden ? (IS_IPAD ? (IS_NOTCHED_SCREEN ? 24 : 20) : PreferredValueForNotchedDevice(IS_LANDSCAPE ? 0 : ([[CIGAMHelper deviceModel] isEqualToString:@"iPhone12,1"] ? 48 : (IS_61INCH_SCREEN_AND_IPHONE12 || IS_67INCH_SCREEN ? 47 : 44)), 20)) : UIApplication.sharedApplication.statusBarFrame.size.height)
...
/// @warn 如果是用于 viewController，请使用 UIViewController(CIGAM) cigam_navigationBarMaxYInViewCoordinator 代替
...
#define SafeAreaInsetsConstantForDeviceWithNotch [CIGAMHelper safeAreaInsetsForDeviceWithNotch]

/// 将所有屏幕按照宽松/紧凑分类，其中 iPad、iPhone XS Max/XR/Plus 均为宽松屏幕，但开启了放大模式的设备均会视为紧凑屏幕
#define PreferredValueForVisualDevice(_regular, _compact) ([CIGAMHelper isRegularScreen] ? _regular : _compact)
...
#define PreferredValueForInterfaceIdiom(_phone, _pad) (APPLICATION_WIDTH / APPLICATION_HEIGHT <= CIGAMHelper.screenSizeFor35Inch.width / CIGAMHelper.screenSizeFor35Inch.height ? _phone : _pad)

/// 区分全面屏和非全面屏
#define PreferredValueForNotchedDevice(_notchedDevice, _otherDevice) ([CIGAMHelper isNotchedScreen] ? _notchedDevice : _otherDevice)
...
#define IPAD_SIMILAR_SCREEN_WIDTH [CIGAMHelper preferredLayoutAsSimilarScreenWidthForIPad]

#define _40INCH_WIDTH [CIGAMHelper screenSizeFor40Inch].width
#define _58INCH_WIDTH [CIGAMHelper screenSizeFor58Inch].width
#define _65INCH_WIDTH [CIGAMHelper screenSizeFor65Inch].width
...
/// 字体相关的宏，用于快速创建一个字体对象，更多创建宏可查看 UIFont+CIGAM.h
...
/// UIColor 相关的宏，用于快速创建一个 UIColor 对象，更多创建的宏可查看 UIColor+CIGAM.h
...
#define CIGAMViewAnimationOptionsCurveOut (7<<16)
#define CIGAMViewAnimationOptionsCurveIn (8<<16)
...
#define CIGAMStatusBarStyleDarkContent [CIGAMHelper statusBarStyleDarkContent]
...
setterWithGetter(SEL getter) {
    ...
    [setterString appendString:getterString.cigam_capitalizedString];
 ...
 *  issue: https://github.com/Tencent/CIGAM_iOS/issues/203
 */
CG_INLINE CGFloat
