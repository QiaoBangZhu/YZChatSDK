...
//  CIGAMKit
//
//  Created by CIGAM Team on 2018/8/14.
//
...
@interface CIGAMPropertyDescriptor : NSObject
...
OverrideImplementation(Class targetClass, SEL targetSelector, id (^implementationBlock)(__unsafe_unretained Class originClass, SEL originCMD, IMP (^originalIMPProvider)(void))) {
    ...
    IMP (^originalIMPProvider)(void) = ^IMP(void) {
        ...
        if (hasOverride) {
            ...
            // https://github.com/Tencent/CIGAM_iOS/issues/776
    ...
    if (hasOverride) {
        ...
        const char *typeEncoding = method_getTypeEncoding(originMethod) ?: [targetClass instanceMethodSignatureForSelector:targetSelector].cigam_typeEncoding;
 ...
 */
#define _CIGAMTypeEncodingDetectorGenerator(_TypeInFunctionName, _typeForEncode) \
...
_CIGAMTypeEncodingDetectorGenerator(Char, char)
_CIGAMTypeEncodingDetectorGenerator(Int, int)
_CIGAMTypeEncodingDetectorGenerator(Short, short)
_CIGAMTypeEncodingDetectorGenerator(Long, long)
_CIGAMTypeEncodingDetectorGenerator(LongLong, long long)
_CIGAMTypeEncodingDetectorGenerator(NSInteger, NSInteger)
_CIGAMTypeEncodingDetectorGenerator(UnsignedChar, unsigned char)
_CIGAMTypeEncodingDetectorGenerator(UnsignedInt, unsigned int)
_CIGAMTypeEncodingDetectorGenerator(UnsignedShort, unsigned short)
_CIGAMTypeEncodingDetectorGenerator(UnsignedLong, unsigned long)
_CIGAMTypeEncodingDetectorGenerator(UnsignedLongLong, unsigned long long)
_CIGAMTypeEncodingDetectorGenerator(NSUInteger, NSUInteger)
_CIGAMTypeEncodingDetectorGenerator(Float, float)
_CIGAMTypeEncodingDetectorGenerator(Double, double)
_CIGAMTypeEncodingDetectorGenerator(CGFloat, CGFloat)
_CIGAMTypeEncodingDetectorGenerator(BOOL, BOOL)
_CIGAMTypeEncodingDetectorGenerator(Void, void)
_CIGAMTypeEncodingDetectorGenerator(Character, char *)
_CIGAMTypeEncodingDetectorGenerator(Object, id)
_CIGAMTypeEncodingDetectorGenerator(Class, Class)
_CIGAMTypeEncodingDetectorGenerator(Selector, SEL)
...
#define _CIGAMGetIvarValueGenerator(_TypeInFunctionName, _typeForEncode) \
...
_CIGAMGetIvarValueGenerator(Char, char)
_CIGAMGetIvarValueGenerator(Int, int)
_CIGAMGetIvarValueGenerator(Short, short)
_CIGAMGetIvarValueGenerator(Long, long)
_CIGAMGetIvarValueGenerator(LongLong, long long)
_CIGAMGetIvarValueGenerator(UnsignedChar, unsigned char)
_CIGAMGetIvarValueGenerator(UnsignedInt, unsigned int)
_CIGAMGetIvarValueGenerator(UnsignedShort, unsigned short)
_CIGAMGetIvarValueGenerator(UnsignedLong, unsigned long)
_CIGAMGetIvarValueGenerator(UnsignedLongLong, unsigned long long)
_CIGAMGetIvarValueGenerator(Float, float)
_CIGAMGetIvarValueGenerator(Double, double)
_CIGAMGetIvarValueGenerator(BOOL, BOOL)
_CIGAMGetIvarValueGenerator(Character, char *)
_CIGAMGetIvarValueGenerator(Selector, SEL)
...
/**
 ...
 int count = cigam_getProjectClassList(&classes);
 Class class = (__bridge Class)classes[0];
 @endcode
 */
FOUNDATION_EXPORT int cigam_getProjectClassList(classref_t **classes);
/**
 检测是否存在某个dyld  image
 */
FOUNDATION_EXPORT BOOL cigam_exists_dyld_image(const char *target_image_name);
