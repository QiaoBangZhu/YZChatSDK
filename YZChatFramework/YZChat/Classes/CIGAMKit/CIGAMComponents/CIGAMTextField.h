...
@protocol CIGAMTextFieldDelegate <UITextFieldDelegate>
 ...
 */
- (void)textField:(CIGAMTextField *)textField didPreventTextChangeInRange:(NSRange)range replacementString:(NSString *)replacementString;
 ...
 */
@interface CIGAMTextField : UITextField

@property(nonatomic, weak) id<CIGAMTextFieldDelegate> delegate;
