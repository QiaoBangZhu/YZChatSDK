...
//
//  CIGAMImagePickerCollectionViewCell.h
//  cigam
//
 ...
 */
@interface CIGAMImagePickerCollectionViewCell : UICollectionViewCell
...
@property(nonatomic, strong, readonly) CIGAMButton *checkboxButton;
...
@property(nonatomic, assign) CIGAMAssetDownloadStatus downloadStatus; // Cell 中对应资源的下载状态，这个值的变动会相应地调整 UI 表现
@property(nonatomic, copy) NSString *assetIdentifier;// 当前这个 cell 正在展示的 CIGAMAsset 的 identifier
