...
//
//  CIGAMSegmentedControl.h
//  cigam
//
//  Created by CIGAM Team on 14/11/3.
//

#import <UIKit/UIKit.h>

/*
 * CIGAMSegmentedControl，继承自 UISegmentedControl
 * 如果需要更大程度地修改样式，比如说字体大小，选中的 segment 的文字颜色等等，可以使用下面的第一个方法来做
 * CIGAMSegmentedControl 也同样支持使用图片来做样式，需要五张图片。
 */
@interface CIGAMSegmentedControl : UISegmentedControl
