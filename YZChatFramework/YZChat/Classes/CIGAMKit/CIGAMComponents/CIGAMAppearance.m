...
@implementation CIGAMAppearance
...
@interface NSObject (CIGAMAppearance_Private)
@property(nonatomic, assign) BOOL cigam_applyingAppearance;
+ (instancetype)appearance;
@end

@implementation NSObject (CIGAMAppearnace)
CIGAMSynthesizeBOOLProperty(cigam_applyingAppearance, setCigam_applyingAppearance)
...
- (void)cigam_applyAppearance {
    ...
    if ([class respondsToSelector:@selector(appearance)]) {
        ...
        self.cigam_applyingAppearance = YES;
        BeginIgnorePerformSelectorLeaksWarning
        ...
        EndIgnorePerformSelectorLeaksWarning
        self.cigam_applyingAppearance = NO;
    }
}
