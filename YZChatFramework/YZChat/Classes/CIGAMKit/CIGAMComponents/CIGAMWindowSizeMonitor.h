...
@protocol CIGAMWindowSizeMonitorProtocol <NSObject>
...
@interface UIResponder (CIGAMWindowSizeMonitor) <CIGAMWindowSizeMonitorProtocol>

@end

typedef void (^CIGAMWindowSizeObserverHandler)(CGSize newWindowSize);

@interface NSObject (CIGAMWindowSizeMonitor)
