...
//
//  CIGAMNavigationBarScrollingAnimator.h
//  CIGAMKit
//
 ...
 */
@interface CIGAMNavigationBarScrollingAnimator : CIGAMScrollAnimator
 ...
 */
@property(nullable, nonatomic, copy) void (^animationBlock)(CIGAMNavigationBarScrollingAnimator * _Nonnull animator, float progress);
...
/**
 ...
 @param progress 当前滚动位置处于 offsetYToStartAnimation 到 (offsetYToStartAnimation + distanceToStopAnimation) 之间的哪个进度
 */
@property(nullable, nonatomic, copy) UIImage * (^backgroundImageBlock)(CIGAMNavigationBarScrollingAnimator * _Nonnull animator, float progress);
...
/**
 ...
 @param progress 当前滚动位置处于 offsetYToStartAnimation 到 (offsetYToStartAnimation + distanceToStopAnimation) 之间的哪个进度
 */
@property(nullable, nonatomic, copy) UIImage * (^shadowImageBlock)(CIGAMNavigationBarScrollingAnimator * _Nonnull animator, float progress);
...
/**
 ...
 @param progress 当前滚动位置处于 offsetYToStartAnimation 到 (offsetYToStartAnimation + distanceToStopAnimation) 之间的哪个进度
 */
@property(nullable, nonatomic, copy) UIColor * (^tintColorBlock)(CIGAMNavigationBarScrollingAnimator * _Nonnull animator, float progress);

/**
 返回不同滚动位置下对应的导航栏的 titleView tintColor，注意只能对使用了 navigationItem.titleView 生效（CIGAMCommonViewController 的子类默认用了 CIGAMNavigationTitleView，所以也可以生效）。
 @param animator 当前的 animator 对象
 @param progress 当前滚动位置处于 offsetYToStartAnimation 到 (offsetYToStartAnimation + distanceToStopAnimation) 之间的哪个进度
 */
@property(nullable, nonatomic, copy) UIColor * (^titleViewTintColorBlock)(CIGAMNavigationBarScrollingAnimator * _Nonnull animator, float progress);
 ...
 */
@property(nullable, nonatomic, copy) UIStatusBarStyle (^statusbarStyleBlock)(CIGAMNavigationBarScrollingAnimator * _Nonnull animator, float progress);
...
/**
 ...
 @param progress 当前滚动位置处于 offsetYToStartAnimation 到 (offsetYToStartAnimation + distanceToStopAnimation) 之间的哪个进度
 */
@property(nonatomic, copy) UIColor * (^barTintColorBlock)(CIGAMNavigationBarScrollingAnimator * _Nonnull animator, float progress);
@end
