...
@interface CIGAMToastAnimator ()<CAAnimationDelegate>
...
@implementation CIGAMToastAnimator
...
- (instancetype)initWithToastView:(CIGAMToastView *)toastView {
...
- (void)zoomAnimationForShow:(BOOL)show withCompletion:(void (^)(BOOL))completion {
    ...
    [UIView animateWithDuration:0.25
                          delay:0.0
                        options:CIGAMViewAnimationOptionsCurveOut|UIViewAnimationOptionBeginFromCurrentState
                     animations:^{
