...
#import "CIGAMCore.h"
#import "CIGAMToastAnimator.h"
#import "CIGAMToastContentView.h"
#import "CIGAMToastBackgroundView.h"
#import "CIGAMKeyboardManager.h"
#import "UIView+CIGAM.h"

static NSMutableArray <CIGAMToastView *> *kToastViews = nil;

@interface CIGAMToastView ()

@property(nonatomic, weak) NSTimer *hideDelayTimer;

@end

@implementation CIGAMToastView
...
- (void)didInitialize {
    ...
    self.toastPosition = CIGAMToastViewPositionCenter;
...
- (CIGAMToastAnimator *)defaultAnimator {
    CIGAMToastAnimator *toastAnimator = [[CIGAMToastAnimator alloc] initWithToastView:self];
    return toastAnimator;
}

- (UIView *)defaultBackgrondView {
    CIGAMToastBackgroundView *backgroundView = [[CIGAMToastBackgroundView alloc] init];
    return backgroundView;
}

- (UIView *)defaultContentView {
    CIGAMToastContentView *contentView = [[CIGAMToastContentView alloc] init];
    return contentView;
}
...
- (void)layoutSubviews {
    ...
    UIEdgeInsets marginInsets = UIEdgeInsetsConcat(self.marginInsets, self.parentView.cigam_safeAreaInsets);
    ...
    if ([CIGAMKeyboardManager isKeyboardVisible]) {
        ...
        CGRect keyboardFrame = [CIGAMKeyboardManager currentKeyboardFrame];
        CGRect parentViewRect = [[CIGAMKeyboardManager keyboardWindow] convertRect:self.parentView.frame fromView:self.parentView.superview];
    ...
    if (self.contentView) {
        ...
        if (self.toastPosition == CIGAMToastViewPositionTop) {
            contentViewY = marginInsets.top + self.offset.y;
        } else if (self.toastPosition == CIGAMToastViewPositionBottom) {
        ...
        self.contentView.cigam_frameApplyTransform = contentRect;
...
@interface CIGAMToastView (UIAppearance)

@end

@implementation CIGAMToastView (UIAppearance)
...
+ (void)setDefaultAppearance {
    CIGAMToastView *appearance = [CIGAMToastView appearance];
