 ...
 * 弹窗继承自`CIGAMCommonViewController`，因此可直接使用self.titleView的功能来实现双行标题，具体请查看`CIGAMNavigationTitleView`。
 * `CIGAMDialogViewController`支持以类似`UIAppearance`的方式来统一设置全局的dialog样式，例如`[CIGAMDialogViewController appearance].headerViewHeight = 48;`。
 *
 * @see CIGAMDialogSelectionViewController
 * @see CIGAMDialogTextFieldViewController
 */
@interface CIGAMDialogViewController : CIGAMCommonViewController<CIGAMModalPresentationContentViewControllerProtocol, CIGAMModalPresentationComponentProtocol>
...
@property(nullable, nonatomic, strong, readonly) CIGAMButton *cancelButton;
@property(nullable, nonatomic, strong, readonly) CIGAMButton *submitButton;
 ...
 */
- (void)addCancelButtonWithText:(NSString *)buttonText block:(void (^ _Nullable)(__kindof CIGAMDialogViewController *aDialogViewController))block;
 ...
 */
- (void)addSubmitButtonWithText:(NSString *)buttonText block:(void (^ _Nullable)(__kindof CIGAMDialogViewController *aDialogViewController))block;
 ...
 */
@property(nullable, nonatomic, strong) CIGAMModalPresentationViewController *modalPresentationViewController;
...
@interface CIGAMDialogViewController (UIAppearance)

+ (instancetype)appearance;
@end

/// 表示没有选中的item
extern const NSInteger CIGAMDialogSelectionViewControllerSelectedItemIndexNone;
 ...
 */
@interface CIGAMDialogSelectionViewController : CIGAMDialogViewController<CIGAMTableViewDelegate, CIGAMTableViewDataSource>
...
@property(nullable, nonatomic, strong, readonly) CIGAMTableView *tableView;

@property(nullable, nonatomic, copy) NSArray <NSString *> *items;

/// 表示单选模式下已选中的item序号，默认为CIGAMDialogSelectionViewControllerSelectedItemIndexNone。此属性与 `selectedItemIndexes` 互斥。
...
@property(nullable, nonatomic, copy) void (^cellForItemBlock)(__kindof CIGAMDialogSelectionViewController *aDialogViewController, __kindof CIGAMTableViewCell *cell, NSUInteger itemIndex);
@property(nullable, nonatomic, copy) CGFloat (^heightForItemBlock)(__kindof CIGAMDialogSelectionViewController *aDialogViewController, NSUInteger itemIndex);
@property(nullable, nonatomic, copy) BOOL (^canSelectItemBlock)(__kindof CIGAMDialogSelectionViewController *aDialogViewController, NSUInteger itemIndex);
@property(nullable, nonatomic, copy) void (^didSelectItemBlock)(__kindof CIGAMDialogSelectionViewController *aDialogViewController, NSUInteger itemIndex);
@property(nullable, nonatomic, copy) void (^didDeselectItemBlock)(__kindof CIGAMDialogSelectionViewController *aDialogViewController, NSUInteger itemIndex);
 ...
 */
@interface CIGAMDialogTextFieldViewController : CIGAMDialogViewController
...
- (void)addTextFieldWithTitle:(nullable NSString *)textFieldTitle configurationHandler:(void (^ _Nullable)(CIGAMLabel *titleLabel, CIGAMTextField *textField, CALayer *separatorLayer))configurationHandler;

@property(nullable, nonatomic, copy, readonly) NSArray<CIGAMLabel *> *textFieldTitleLabels;
...
@property(nullable, nonatomic, copy) BOOL (^shouldEnableSubmitButtonBlock)(__kindof CIGAMDialogTextFieldViewController *aDialogViewController);
