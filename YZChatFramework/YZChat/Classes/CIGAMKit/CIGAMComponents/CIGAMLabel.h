...
//  cigam
//
//  Created by CIGAM Team on 14-7-3.
//

#import <UIKit/UIKit.h>

/**
 * `CIGAMLabel`支持通过`contentEdgeInsets`属性来实现类似padding的效果。
 *
...
/// 点击了“复制”后的回调
@property(nonatomic, copy) void (^didCopyBlock)(CIGAMLabel *label, NSString *stringCopied);
