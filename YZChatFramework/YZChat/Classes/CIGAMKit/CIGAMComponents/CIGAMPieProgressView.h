...
typedef NS_ENUM(NSUInteger, CIGAMPieProgressViewShape) {
    CIGAMPieProgressViewShapeSector, // 扇形，默认
    CIGAMPieProgressViewShapeRing // 环形
};

@interface CIGAMPieProgressView : UIControl
...
/**
 绘制形状，默认是扇形。
 */
@property(nonatomic, assign) IBInspectable CIGAMPieProgressViewShape shape;
