...
//  cigam
//
//  Created by CIGAM Team on 2017/6/1.
//
...
- (void)updateThumbImage {
    if (!CGSizeIsEmpty(self.thumbSize)) {
        ...
        UIImage *thumbImage = [UIImage cigam_imageWithShape:CIGAMImageShapeOval size:_thumbSize tintColor:thumbColor];
...
- (UIView *)thumbViewIfExist {
    ...
    UIView *thumbView = [self cigam_valueForKey:@"thumbView"];
    return thumbView;
}
