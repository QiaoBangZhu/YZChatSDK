...
CG_INLINE CGFloat
CIGAM_Linear(CGFloat t) {
    return t;
}

CG_INLINE CGFloat
CIGAM_EaseInSine(CGFloat t) {
    return 1 - cos(t * M_PI_2);
}

CG_INLINE CGFloat
CIGAM_EaseOutSine(CGFloat t) {
    return sin(t * M_PI_2);
}

CG_INLINE CGFloat
CIGAM_EaseInOutSine(CGFloat t) {
    return - (cos(M_PI * t) - 1) / 2;
}

CG_INLINE CGFloat
CIGAM_EaseInQuad(CGFloat t) {
    return pow(t, 2);
}

CG_INLINE CGFloat
CIGAM_EaseOutQuad(CGFloat t) {
    return 1 - pow(1 - t, 2);
}

CG_INLINE CGFloat
CIGAM_EaseInOutQuad(CGFloat t) {
    return t < 0.5 ? (2 * pow(t, 2)) : (1 - pow(-2 * t + 2, 2) / 2);
}

CG_INLINE CGFloat
CIGAM_EaseInCubic(CGFloat t) {
    return pow(t, 3);
}

CG_INLINE CGFloat
CIGAM_EaseOutCubic(CGFloat t) {
    return 1 - pow(1 - t, 3);
}

CG_INLINE CGFloat
CIGAM_EaseInOutCubic(CGFloat t) {
    return t < 0.5 ? (4 * pow(t, 3)) : (1 - pow(-2 * t + 2, 3) / 2);
}

CG_INLINE CGFloat
CIGAM_EaseInQuart(CGFloat t) {
    return pow(t, 4);
}

CG_INLINE CGFloat
CIGAM_EaseOutQuart(CGFloat t) {
    return 1 - pow(1 - t, 4);
}

CG_INLINE CGFloat
CIGAM_EaseInOutQuart(CGFloat t) {
    return t < 0.5 ? (8 * pow(t, 4)) : (1 - pow(-2 * t + 2, 4) / 2);
}

CG_INLINE CGFloat
CIGAM_EaseInQuint(CGFloat t) {
    return pow(t, 5);
}

CG_INLINE CGFloat
CIGAM_EaseOutQuint(CGFloat t) {
    return 1 - pow(1 - t, 5);
}

CG_INLINE CGFloat
CIGAM_EaseInOutQuint(CGFloat t) {
    return t < 0.5 ? (16 * pow(t, 5)) : (1 - pow(-2 * t + 2, 5) / 2);
}

CG_INLINE CGFloat
CIGAM_EaseInExpo(CGFloat t) {
    return t == 0 ? 0 : pow(2, 10 * t - 10);
}

CG_INLINE CGFloat
CIGAM_EaseOutExpo(CGFloat t) {
    return t == 1 ? 1 : 1 - pow(2, -10 * t);
}

CG_INLINE CGFloat
CIGAM_EaseInOutExpo(CGFloat t) {
    return t == 0 ? 0 : t == 1 ? 1 : t < 0.5 ? pow(2, 20 * t - 10 ) / 2 : (2 - pow(2, -20 * t + 10 )) / 2;
}

CG_INLINE CGFloat
CIGAM_EaseInCirc(CGFloat t) {
    return 1 - sqrt(1 - pow(t, 2));
}

CG_INLINE CGFloat
CIGAM_EaseOutCirc(CGFloat t) {
    return sqrt(1 - pow(t - 1, 2));
}

CG_INLINE CGFloat
CIGAM_EaseInOutCirc(CGFloat t) {
    return t < 0.5 ? (1 - sqrt(1 - pow(2 * t, 2))) / 2 : (sqrt(1 - pow(-2 * t + 2, 2)) + 1) / 2;
}

CG_INLINE CGFloat
CIGAM_EaseInBack(CGFloat t) {
    return pow(t, 3) - t * sin(t * M_PI);
}

CG_INLINE CGFloat
CIGAM_EaseOutBack(CGFloat t) {
    CGFloat f = (1 - t);
    return 1 - (pow(f, 3) - f * sin(f * M_PI));
}

CG_INLINE CGFloat
CIGAM_EaseInOutBack(CGFloat t) {
    if (t < 0.5) {
        CGFloat f = 2 * t;
...
CG_INLINE CGFloat
CIGAM_EaseInElastic(CGFloat t) {
    return sin(13 * M_PI_2 * t) * pow(2, 10 * (t - 1));
}

CG_INLINE CGFloat
CIGAM_EaseOutElastic(CGFloat t) {
    return sin(-13 * M_PI_2 * (t + 1)) * pow(2, -10 * t) + 1;
}

CG_INLINE CGFloat
CIGAM_EaseInOutElastic(CGFloat t) {
    if (t < 0.5) {
...
CG_INLINE CGFloat
CIGAM_EaseInBounce(CGFloat t) {
    return 1 - CIGAM_EaseOutBounce(1 - t);
}

CG_INLINE CGFloat
CIGAM_EaseInOutBounce(CGFloat t) {
    if (t < 0.5) {
        return 0.5 * CIGAM_EaseInBounce(t * 2);
    } else {
        return 0.5 * CIGAM_EaseOutBounce(t * 2 - 1) + 0.5;
    }
}

CG_INLINE CGFloat
CIGAM_EaseSpring(CGFloat t, CGFloat mass, CGFloat damping, CGFloat stiffness, CGFloat initialVelocity) {
