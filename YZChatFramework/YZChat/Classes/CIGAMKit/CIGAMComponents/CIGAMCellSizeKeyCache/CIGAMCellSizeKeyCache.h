 ...
 *  具体使用方式请看 UICollectionView (CIGAMCellSizeKeyCache) 的注释。
 */
@interface CIGAMCellSizeKeyCache : NSObject
...
// 使 cache 失效，多用在 data 更新之后或 UICollectionView 的 size 发生变化的时候，但在 CIGAM 里，UICollectionView 的 size 发生变化会自动更新，所以不用处理 size 变化的场景。
