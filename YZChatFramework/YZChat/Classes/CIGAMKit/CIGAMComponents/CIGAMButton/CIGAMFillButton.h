...
typedef NS_ENUM(NSUInteger, CIGAMFillButtonColor) {
    CIGAMFillButtonColorBlue,
    CIGAMFillButtonColorRed,
    CIGAMFillButtonColorGreen,
    CIGAMFillButtonColorGray,
    CIGAMFillButtonColorWhite,
};
 ...
 */
@interface CIGAMFillButton : CIGAMButton
