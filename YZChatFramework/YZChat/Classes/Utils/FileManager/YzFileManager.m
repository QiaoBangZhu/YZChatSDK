...
{
    return [[YzFileManager pathForApplicationSupportDirectory] stringByAppendingPathComponent:path];
}
...
{
    return [[YzFileManager pathForCachesDirectory] stringByAppendingPathComponent:path];
}
...
{
    return [[YzFileManager pathForDocumentsDirectory] stringByAppendingPathComponent:path];
}
...
{
    return [[YzFileManager pathForLibraryDirectory] stringByAppendingPathComponent:path];
}
...
{
    return [[YzFileManager pathForMainBundleDirectory] stringByAppendingPathComponent:path];
}
...
{
    return [[YzFileManager pathForTemporaryDirectory] stringByAppendingPathComponent:path];
}
