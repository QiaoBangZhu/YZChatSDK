...
- (void)loadPath:(NSString*)filePath
{
    ...
    NSArray *groupItems = [YZPAirSandbox sharedInstance].groupItems;
...
@implementation YZPAirSandbox

+ (instancetype)sharedInstance
{
    static YZPAirSandbox* instance = nil;

    static dispatch_once_t onceToken;
    dispatch_once(&onceToken, ^{
        instance = [YZPAirSandbox new];
    });
