...
//Location cell
#define LocationMessageCell_ReuseId @"LocationMessageCell"
...
#define TConversationCell_Margin 11
#define TConversationCell_Margin_Text 12
