...
@interface TUISelectMemberViewController ()<UICollectionViewDelegate,UICollectionViewDataSource,UICollectionViewDelegateFlowLayout,UITableViewDelegate,UITableViewDataSource,SearchBarDelegate>
...
//    self.view.backgroundColor = [UIColor d_colorWithColorLight:TController_Background_Color dark:TController_Background_Color_Dark];
    self.view.backgroundColor = [UIColor colorWithRed:244/255.0 green:246/255.0 blue:249/255.0 alpha:1];
...
- (UITableView *)selectTable {
    if (!_selectTable.superview) {
        ...
        _selectTable.separatorColor = [UIColor colorWithRed:233/255.0 green:235/255.0 blue:236/255.0 alpha:1];
        [self.view addSubview:_selectTable];
        _selectTable.mm_width(self.view.mm_w).mm_top(self.topStartPosition ).mm_flexToBottom(0);
    }
    return _selectTable;
}
