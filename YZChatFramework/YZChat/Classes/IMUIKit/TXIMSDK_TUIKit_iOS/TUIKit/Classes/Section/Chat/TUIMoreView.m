...
//    self.backgroundColor = [UIColor d_colorWithColorLight:TInput_Background_Color dark:TInput_Background_Color_Dark];
    self.backgroundColor = [UIColor colorWithRed:244/255.0 green:246/255.0 blue:249/255.0 alpha:1.0];
    ...
    _lineView.backgroundColor = [UIColor colorWithRed:233/255.0 green:235/255.0 blue:236/255.0 alpha:1.0]; //[UIColor d_colorWithColorLight:TLine_Color dark:TLine_Color_Dark];
...
- (void)defaultLayout
{
    ...
    _moreCollectionView.frame = CGRectMake(0, _lineView.frame.origin.y + _lineView.frame.size.height + TMoreView_Margin + 9, self.frame.size.width, collectionHeight);
