...
@interface YRegViewController ()<TextFieldInputViewDelegate>
...
@implementation YRegViewController
...
- (YZTextFieldInputView*)confirmPasswordField {
    if (!_confirmPasswordField) {
        _confirmPasswordField = [[YZTextFieldInputView alloc]initWith:TextInputTypeNormal];
...
- (UIButton*)checkBoxBtn {
    if (!_checkBoxBtn) {
        ...
        [_checkBoxBtn setImage:YZChatResource(@"checkbox_unselect_small") forState:UIControlStateNormal];
