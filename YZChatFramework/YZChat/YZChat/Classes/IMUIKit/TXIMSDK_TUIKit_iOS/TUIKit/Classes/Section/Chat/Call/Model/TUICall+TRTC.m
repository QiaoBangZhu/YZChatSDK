...
- (void)enterRoom {
    ...
    param.userId = ([TUIKit sharedInstance].userID == nil || [TUIKit sharedInstance].userID.length == 0 || [[TUIKit sharedInstance].userID isEqualToString:@""]) ?[[NSUserDefaults standardUserDefaults]objectForKey:@"YUserId"]: [TUIKit sharedInstance].userID;
    param.userSig = ([TUIKit sharedInstance].userSig == nil || [TUIKit sharedInstance].userSig.length == 0 || [[TUIKit sharedInstance].userSig isEqualToString:@""] == YES) ? [[NSUserDefaults standardUserDefaults]objectForKey:@"YUserSign"] : [TUIKit sharedInstance].userSig;
