//
//  YUIConversationListController.m
//  YChat
//
...
@interface YUIConversationListController ()<UIGestureRecognizerDelegate, UITableViewDelegate, UITableViewDataSource, UIPopoverPresentationControllerDelegate,UISearchControllerDelegate>

@end

@implementation YUIConversationListController
...
- (YConversationListViewModel *)viewModel
{
    if (!_viewModel) {
        _viewModel = [YConversationListViewModel new];
    }
    return _viewModel;
}
