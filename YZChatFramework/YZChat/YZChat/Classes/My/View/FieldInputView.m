...
@interface FieldInputView() <QMUITextFieldDelegate>

@end

@implementation FieldInputView
...
- (Line*)line {
    if (!_line) {
        _line = [[Line alloc]initWithAutoUpdateHeight:true normalColor:[UIColor lightGrayColor] highlightedColor:[UIColor colorWithHex:KCommonBlueBubbleColor]];
    }
    return _line;
}
